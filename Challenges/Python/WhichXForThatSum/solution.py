...
# Solution:
# Use derivative of formula for infinite geometric series with ratio = x, calculate the roots and find out which one is correct by substituting given value for m
